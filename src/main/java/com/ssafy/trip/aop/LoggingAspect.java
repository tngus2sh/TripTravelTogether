...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.trip.*.model..*(..))")
	...
	@Around(value = "execution(* com.ssafy.trip.*.model..*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.trip.*.model..*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.trip.*.model..*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.trip.*.model..*.list*(..))")
